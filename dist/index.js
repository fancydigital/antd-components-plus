...
var PropsType = require('prop-types');
var moment = require('moment');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
var PropsType__default = /*#__PURE__*/_interopDefaultLegacy(PropsType);
...
var mapCollection = function mapCollection(collection, callback) {
  var fn = callback;

  if (isPlainObject_1(collection)) {
    fn = function fn(label, key) {
      return callback({
        key: key,
        label: label
      });
  ...
  return map_1(collection, fn);
};

var getAllOption = function getAllOption(allOption) {
  if (allOption === false) {
    return null;
  } else {
    if (allOption === true) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(antd.Select.Option, {
      key: "".concat(allOption.key),
      value: "".concat(allOption.key)
    }, allOption.label);
  }
};
/**
...
var Select2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Select2, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$fieldName = _this$props.fieldNames,
          fieldNames = _this$props$fieldName === void 0 ? {
        label: 'label',
        key: 'key',
        value: 'key'
      } : _this$props$fieldName,
          _this$props$allOption = _this$props.allOption,
          allOption = _this$props$allOption === void 0 ? false : _this$props$allOption,
          _this$props$getOption = _this$props.getOption,
          getOption = _this$props$getOption === void 0 ? function (optiom) {
        return {
          label: optiom[fieldNames.label],
          key: optiom[fieldNames.key],
          value: optiom[fieldNames.value || fieldNames.key]
        };
      } : _this$props$getOption,
          mode = _this$props.mode,
          _this$props$allowClea = _this$props.allowClear,
          allowClear = _this$props$allowClea === void 0 ? !!mode : _this$props$allowClea,
          selectProps = _objectWithoutProperties(_this$props, ["dataSource", "fieldNames", "allOption", "getOption", "mode", "allowClear"]);
      ...
      }, selectProps), getAllOption(allOption), mapCollection(dataSource, function (option) {
        var _getOption = getOption(option),
            label = _getOption.label,
            key = _getOption.key,
            _getOption$value = _getOption.value,
            value = _getOption$value === void 0 ? key : _getOption$value,
            optionProps = _objectWithoutProperties(_getOption, ["label", "key", "value"]);

        key = isUndefined_1(key) ? value : key;
        return /*#__PURE__*/React__default['default'].createElement(antd.Select.Option, _extends({}, optionProps, {
          key: key,
          value: value
        }), label);
      }));
...
_defineProperty(Select2, "PropsType", _defineProperty({
  fieldNames: PropsType__default['default'].object,
  allOption: PropsType__default['default'].oneOfType([PropsType__default['default'].bool, PropsType__default['default'].object]),
  getOption: PropsType__default['default'].func
}, "fieldNames", PropsType__default['default'].object));
Select2.Option = antd.Select.Option;
...
var DatePickerRange = /*#__PURE__*/function (_PureComponent) {
  _inherits(DatePickerRange, _PureComponent);

  var _super = _createSuper(DatePickerRange);
  ...
  function DatePickerRange() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (value) {
      var _this$props = _this.props,
          ...
          _this$props$momentVal = _this$props.momentValue,
          momentValue = _this$props$momentVal === void 0 ? false : _this$props$momentVal,
      ...
      if (momentValue === true || value.length === 0) {
        ...
        if (Array.isArray(names) && names.length === 2) {
          ...
          onChange((_onChange = {}, _defineProperty(_onChange, names[0], valuesString[0]), _defineProperty(_onChange, names[1], valuesString[1]), _onChange)); // {'state_date':'2020-10-10','end_date':'2020-10-12'}
        } else {
  ...
  _createClass(DatePickerRange, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          format = _this$props2$format === void 0 ? DEFAULT_DATE_FORMAT : _this$props2$format,
          props = _objectWithoutProperties(_this$props2, ["value", "defaultValue", "names", "format"]);
      ...
      if (Array.isArray(value) && value.length === 2) {
        if (value[0] === undefined && value[1] === undefined) {
          ...
          value = [moment__default['default'](value[0]), moment__default['default'](value[1])];
        }
      }

      return /*#__PURE__*/React__default['default'].createElement(RangePicker, _extends({}, props, {
        value: value,
...
_defineProperty(DatePickerRange, "PropsType", {
  // 是否返回moment类型的值，默认是false
  momentValue: PropsType__default['default'].bool,
  // 用于daterange将值重新保存到对象。 ['start_date','end_date'] => {'state_date':'','end_date':''}
  names: PropsType__default['default'].array
});
...
var DatePicker2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function DatePicker2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (value) {
      ...
      if (momentValue === true) {
        ...
        onChange(moment__default['default'].isMoment(value) ? value.format(format) : value);
      }
    });
  ...
  _createClass(DatePicker2, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          _this$props2$format = _this$props2.format,
          format = _this$props2$format === void 0 ? DEFAULT_DATE_FORMAT : _this$props2$format,
          props = _objectWithoutProperties(_this$props2, ["value", "format"]);

      if (!moment__default['default'].isMoment(value) && !isEmpty_1(value)) {
...
_defineProperty(DatePicker2, "PropsType", {
  // 是否返回moment类型的值，默认是false
  momentValue: PropsType__default['default'].bool
});
DatePicker2.RangePicker = DatePickerRange;
